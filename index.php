...
<h3>Gmail</h3>
  ...
  <ul class="nav nav-pills">
    <li class="nav-item">
      <a class="nav-link" href="forms/signup.php">SIGN-UP</a>
    </li>
    <li class="nav-item">
...
<div>
  <div style="width: 1536px; height: 633px; background-color:#f95e5e;">
  <div>
      <center><img src="logo-gmail.png" style="height: 633px;"></center>
  </div>
    <div class="hero_home__copy" style="width:700px;">
      <h1 style="color:black; z-index:10; padding-top:15%;padding-right:25%;">The ease &amp; simplicity of Gmails</h1>
